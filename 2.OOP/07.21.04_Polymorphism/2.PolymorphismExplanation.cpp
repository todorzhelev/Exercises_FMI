...
//за всеки клас, в който има поне 1 виртуална функция се създава 1 виртуална таблица (vtable)
//във виртуалната таблица има указатели към виртуалните функции за този клас
//ако даден клас наследява друг клас, в който има виртуални функции, и наследеният клас получава собствена виртуална таблица
...
//подробно обяснение: http://www.learncpp.com/cpp-tutorial/125-the-virtual-table/
class Animal
{
public:
	virtual void Sleep()
